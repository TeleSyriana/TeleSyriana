...
# This pair appears in both startup and user-change paths. Patch startup only;
# the user-change bundle is replaced separately below.
s = replace_first_required(
    s,
    '  subscribeGroupsCloud();\n  subscribeRecentsCloud();',
    '  syncMessagesPageRealtime();',
...
# The generic nav listener appears twice. Patch the first startup instance only.
s = replace_first_required(
    s,
    ...
    "messages startup navigation lifecycle",
)
...
print("Quota hotfix v3 source patches applied successfully.")
